QuickHeal is a simple QoL mod that adds a keybind (default: H) that will consume the first edible item in your inventory that has a net positive Health/Energy gain.
